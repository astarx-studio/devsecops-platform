...
| [05 — Networking](./05_networking.md) | Docker network topology, Traefik static/dynamic config, Kong declarative config, DNS strategy, public ingress modes (direct / `cftunnel` / `vpnedge`) |
