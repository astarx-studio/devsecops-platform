...
- **[Operator console (frontend)](02_frontend_console.md)** — Shipped as `console/` in this repo at `console.devops.<DOMAIN>` (oauth2-proxy + API-key BFF). _Status: Shipped (see `console/` and `99_maintainers/02_services.md`)._
