...
If you lose `.vols/mongo/` or `.vols/traefik/`, MongoDB and Traefik will reinitialize from empty state on next boot, and Traefik will request new certificates automatically.
